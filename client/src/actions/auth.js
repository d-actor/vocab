...
export const registerUser = (email, nickname, password, passwordConfirmation, history) => {
  return dispatch => {
    axios.post('/api/auth', { email, nickname, password, password_confirmation: passwordConfirmation })
      .then(res => {
